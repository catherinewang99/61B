...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Settings->Make player Auto", this::newGame);
        addMenuButton("Settings->Make player Manual", this::newSeed);
    ...
    private void newGame(String dummy){_pendingCommands.offer("new");
    }
