...
final class Controller {
    ...
    /** Command move based on the pattern entered. */
    private void doMove(Matcher matchString) {
        // Work Fixme
        System.out.println("This command runs");
        System.out.println(matchString.group());
        Move m = Move.mv(matchString.group());
    ...
    private void doManual(Matcher matchString) {
        String player = matchString.group(1); //not sure if the syntax is correct
    ...
    /** Auto Move of the Game. */
    private void doAuto(Matcher matchString) {
        String player = matchString.group(1);
        System.out.println(player);
        if (player.equals("white")) {
